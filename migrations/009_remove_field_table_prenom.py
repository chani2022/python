"""Peewee migrations -- 009_remove_field_table_prenom.py.
...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.change_fields('prenom', prenom=pw.CharField(default='NULL', max_length=255))
...
def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    #     type_acte = pw.CharField(default='NULL', max_length=255)
    #     famille = pw.ForeignKeyField(column_name='famille_id', field='id', model=migrator.orm['famille'])
    #     date_traitement = pw.DateField(default='NULL')
    #     heure_traitement = pw.TimeField(default='NULL')
    #     user = pw.ForeignKeyField(column_name='user_id', field='id', model=migrator.orm['user'])
    #     nom_fichier = pw.CharField(default='NULL', max_length=255)
