"""Peewee migrations -- 003_update_table_ville_to_null.py.
...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.drop_not_null('ville', 'ville')

    migrator.drop_not_null('ville', 'code_commune')

    migrator.drop_not_null('ville', 'region')

    migrator.drop_not_null('ville', 'departement')
...
def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.change_fields('ville', ville=pw.CharField(default='NULL', max_length=255),
    ...
    migrator.add_not_null('ville', 'ville')

    migrator.add_not_null('ville', 'code_commune')

    migrator.add_not_null('ville', 'region')

    migrator.add_not_null('ville', 'departement')
